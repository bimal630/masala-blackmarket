...
-- Events
RegisterNetEvent("masala-blackmarket:client:UpdateShop", function(shop, itemData, amount)
    TriggerServerEvent("masala-blackmarket:server:UpdateShopItems", shop, itemData, amount)
end)

RegisterNetEvent("masala-blackmarket:client:SetShopItems", function(shop, shopProducts)
    Config.Locations[shop]["products"] = shopProducts
end)

RegisterNetEvent("masala-blackmarket:client:RestockShopItems", function(shop, amount)
...
local function openShop(shop, data)
    ...
    local ShopItems = {}
    ShopItems.items = {}
    QBCore.Functions.TriggerCallback("masala-blackmarket:server:getLicenseStatus", function(hasLicense, hasLicenseItem)
        ...
        while listen do
            if IsControlJustPressed(0, 38) then -- E
                if inChips then
                    ...
                    TriggerServerEvent("masala-blackmarket:server:sellChips")
                else
                    exports["qb-core"]:KeyPressed()
